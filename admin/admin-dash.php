...
<body>
    ...
    <div class="container-body">
        ...
        <div class="details">
            <?php
            $sqlstat = "SELECT * FROM `site_stat`";
            $resultstat = mysqli_query($con, $sqlstat);
            $stat = $resultstat->fetch_assoc();
            ?>
            <h1>Site Status</h1>
            <div class="details">
                <p><strong>Visit count:</strong> 2nd International Conference on Big Data, IoT and Machine Learning (BIM)</p>
                <div class="website-counter">
                    <?php echo $stat['visitor'] ?>
                </div>
            </div>
        </div>
        <div class="details">
        ...
        <div class="details">
            <div class="app-table-wrap">
                <table class="app-table">
                    ...
                    <tbody>
                        <?php
                        $sql = "SELECT * FROM `applications` ORDER BY `timestrap` ASC;";
